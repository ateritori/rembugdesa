...
@section('content')
    <div class="container mx-auto px-4 py-8">
            ...
            <div class="px-6 py-4">
                <dl class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <dd class="mt-1 text-gray-900">{{ $decisionSession->created_at?->format('d/m/Y H:i') ?? 'N/A' }}
                        </dd>
                    </div>
                    <div>
                        <dt class="text-sm font-medium text-gray-500">Diperbarui</dt>
                        <dd class="mt-1 text-gray-900">{{ $decisionSession->updated_at?->format('d/m/Y H:i') ?? 'N/A' }}
                        </dd>
                    </div>
                </dl>
            </div>
        ...
        <div class="mt-6">
            ...
            <a href="{{ route('decision-sessions.edit', $decisionSession->id) }}"
                class="inline-block ml-3 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
                Edit
            </a>
        </div>
    </div>
