                        ...
                        <div class="flex w-full items-center justify-end gap-1.5 md:w-auto">
                            ...
                            @if ($s->status === 'closed')
                                <div
                                    ...
                                    {{-- Decision Provenance --}}
                                    <a href="{{ route('decision-sessions.provenance.index', $s->id) }}"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                                            ...
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M9 17v-2a4 4 0 014-4h4m0 0l-3-3m3 3l-3 3M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                        </svg>
