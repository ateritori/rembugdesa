      ...
      <div class="relative z-10 flex flex-col justify-between gap-8 md:flex-row md:items-center">
        <div class="max-w-2xl">
          <div class="mb-4 flex items-center gap-3">
            ...
            <span class="text-[10px] font-black uppercase tracking-[0.3em] text-blue-400">Decision Workspace</span>
          </div>
    ...
    @php
      $steps = [
          [
              ...
              'done' => $dmHasCompleted,
              'link' => route('dms.index', ['decisionSession' => $decisionSession->id, 'tab' => 'penilaian-kriteria']),
          ],
          [
              'label' => 'TAHAP 2',
          ...
          [
              ...
              'link' => route('dms.index', ['decisionSession' => $decisionSession->id, 'tab' => 'evaluasi-alternatif']),
          ],
          [
              'label' => 'TAHAP 4',
              'title' => 'Ranking Akhir',
    ...
    @foreach ($steps as $index => $step)
      ...
      <a href="{{ $isDisabled ? 'javascript:void(0)' : $step['link'] }}"
        ...
        <div
          ...
          <div>
            <p class="mb-1 text-[10px] font-black uppercase tracking-widest text-slate-400">{{ $step['label'] }}</p>
            <h4 class="{{ $isDisabled ? 'text-slate-400' : 'text-slate-800' }} text-xl font-black">{{ $step['title'] }}
            </h4>
          </div>
