...
@section('content')
  ...
  <div class="space-y-6 rounded-xl border border-gray-200 bg-white p-6">
    ...
    <div
      class="flex flex-col gap-4 rounded-xl border border-gray-200 bg-white p-4 shadow-sm md:flex-row md:items-center md:divide-x md:divide-gray-100 md:p-2">

      {{-- 1. Status Utama --}}
      <div class="flex items-center gap-3 md:flex-1 md:px-4">
        <div
        ...
        <div>
          <p class="mb-1 text-[10px] font-bold uppercase leading-none tracking-wider text-gray-400">Status Sesi</p>
      ...
      <div
        class="grid grid-cols-3 gap-2 border-y border-gray-50 py-4 md:flex md:flex-[2] md:items-center md:justify-around md:border-none md:px-6 md:py-0">
        ...
        <div class="flex flex-col items-center border-x border-gray-50 px-2 md:items-start md:border-none">
