  ...
  <div
    ...
    <div class="mx-auto w-full max-w-[480px]">
      <div
        ...
        <form method="POST" action="{{ route('password.store') }}" class="relative z-10 space-y-5 md:space-y-6">
          @csrf
          ...
          <div class="group space-y-2">
            ...
            <input id="password_confirmation" type="password" name="password_confirmation" required
              class="w-full rounded-xl border-2 border-[#f5f5f4] bg-[#fafaf9] px-5 py-4 text-sm font-bold text-[#2d1a12] outline-none transition-all duration-300 placeholder:text-[#d6d3d1] focus:border-[#7f1d1d] focus:bg-white focus:text-[#2d1a12]"
              placeholder="••••••••">
            <x-input-error :messages="$errors->get('password_confirmation')" class="mt-1 px-1 text-[10px] font-bold italic text-[#b91c1c]" />
          </div>
